...
func NewPathContainerNode(Error error,Path string) PathContainer[Node] {
	Err := Error.(*NodeError)
...
func (Instance *PathContainerNode[T]) Split(SplitPoint int, NewNode PathContainer[T]) (PathContainer[T], error) {
	var Zero PathContainer[T]
